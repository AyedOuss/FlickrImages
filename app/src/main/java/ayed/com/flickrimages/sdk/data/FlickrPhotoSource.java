...
import ayed.com.flickrimages.sdk.util.UrlFetchTask;
...
public class FlickrPhotoSource extends PhotoSource implements PhotoListRequestCompleted {
    ...
    private static final String API_KEY = "9e41eaa20d34e3a4d6eb8e2fdea7eba0";
    ...
    protected void parseGetSizesResponse(String xml) {
        ...
        try {
            ...
            onPhotoListRequestCompleted((ArrayList<Photo>) null);
            return;
        } catch(IOException e) {
            onPhotoListRequestCompleted((ArrayList<Photo>) null);
            return;
